...
interface IClsRewardController {
    ...
    function cancelVote(uint256 roundId, uint256 poolId, uint256 vote) external;

    function getPoolIds(uint256 roundId) external view returns (uint256[] memory);

    function castVote(uint256 roundId, uint256 poolId, uint256 vote) external;

    function getTotalClsAvailable(uint256 roundId) external view returns (uint256);

    function rounds(uint256) external view returns (uint256 maxAdminAllocPoint, uint256 maxUserAllocPoint, uint256 maxLinkAllocPoint, uint256 numPools, uint256 startBlock, uint256 startTime, uint256 endTime, uint256 totalUserVotes, uint256 totalAdminVotes, uint256 totalClsAmount );
